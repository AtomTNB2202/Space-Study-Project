...
from app.crud import booking as crud_booking  # để kiểm tra user owns booking
...
def create_rating(
    ...
    return crud_rating.create_rating(db, data, current_user.id)
...
def delete_rating(
    ...
    crud_rating.delete_rating(db, db_obj, current_user.id)
    return
